...
- July 7, 2025: Implemented dynamic planet type seeding in SystemGenerator.determinePlanetType() method. Planet types now vary each session by adding timestamp to the seed, creating different planetary compositions while maintaining consistent orbital mechanics and other planet properties. Stars remain deterministic with fixed seed 12345 for consistent galactic layout.
