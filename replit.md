...
- July 24, 2025: Rebuilt fleet movement system with simplified teleportation mechanics. When a fleet is selected, clicking anywhere on the orbital disk immediately teleports the fleet to that position while maintaining orbital rotation around the new location. Removed complex animation system in favor of instant movement. Fleet movement now uses direct position updates with preserved orbital mechanics for realistic space fleet behavior.
