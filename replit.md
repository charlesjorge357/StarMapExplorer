...
- July 7, 2025: Scaled down orbital distances by factor of ~6 for realistic AU measurements. Reduced base spacing from 20 to 3 AU, orbital zone boundaries from 1.5/4.0 to 0.25/0.7 AU (temperature-scaled), and maximum system radius from 300+ AU to ~60 AU maximum. Planets now show realistic orbital distances matching our Solar System scale.
