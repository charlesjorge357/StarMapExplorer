...
- July 7, 2025: Fixed orbital distance display by adding AU conversion factor. Applied division by 6 to orbital radius values in UI display while maintaining correct 3D visual positioning. Planets now show realistic AU values (max ~60 AU) instead of inflated internal positioning units (300+ units), without affecting the visual spacing in system view.
